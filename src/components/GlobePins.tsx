...
export interface GlobePinsProps {
...
const DEFAULT_PROPS: GlobePinsProps = {
    ...
    pins: [
        {
            ...
            lat: 18.5204,
            name: "Pune",
            address: "Raje Shivaji Climbing Wall\nGanpathi Chowk, behind Canara Bank ATM\nShivajinagar, Pune, Maharashtra 411005",
        ...
        },
        {
            ...
            address: "Annasaheb Magar Stadium\nTrishul Sahakari Housing Society\nYashwantnagar, Pimpri Colony, Pimpri-Chinchwad, Maharashtra 411018",
...
// ================= Component =================
export default function GlobePins(props: Partial<GlobePinsProps>) {
    const cfg = { ...DEFAULT_PROPS, ...props } as GlobePinsProps
